...
function Section({
  ...
  const pad = spacing === "tight" ? "py-10 md:py-14" : "py-20 md:py-28";
  const bodyTop = spacing === "tight" ? "mt-7 md:mt-10" : "mt-12 md:mt-16";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: `relative mx-auto max-w-7xl px-4 ${pad} ${className}`, children: [
    (title || description) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `max-w-3xl ${center ? "mx-auto text-center" : ""}`, children: [
      title && /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-0 text-3xl md:text-5xl font-bold leading-tight", children: title }),
      description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 md:mt-4 text-base md:text-lg text-muted-foreground", children: description })
    ] }),
...
function PageHero({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      className: cn(
        "relative overflow-hidden border-b border-border/50 pt-24 pb-8 md:pt-28 md:pb-10",
        className
      ),
      children: [
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: split ? "text-center lg:text-left" : "", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h1",
                  {
                    className: `font-display mt-0 font-bold leading-tight tracking-tight text-3xl md:text-4xl lg:text-5xl ${split ? "" : "mx-auto max-w-3xl"}`,
                    children: title
                  }
                ),
