...
import { Z as Zap, m as Cpu, s as Cloud, D as Database, t as GitBranch, u as Terminal, i as Activity } from "../_libs/lucide-react.mjs";
...
function AILab() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHero, { className: "pb-5 md:pb-6", title: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      "Your ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "cloud workbench" }),
      " for AI"
    ] }), description: "Spin up GPUs in seconds. Train, fine-tune, and deploy real models — no setup required." }),
