...
import { R as Radio, f as Clock, g as ArrowRight } from "../_libs/lucide-react.mjs";
...
const heroFeatured = "/assets/hero-BUNljQNY.png";
...
function News() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CampusBuildingHeader, { route: "/news" }),
