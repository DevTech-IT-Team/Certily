...
import { F as Flame, h as Trophy, B as BookOpen, Z as Zap, i as Activity, j as Brain, g as Calendar, k as ArrowUpRight, l as ChartColumn, m as Cpu, n as CodeXml } from "../_libs/lucide-react.mjs";
...
function Dashboard() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    ] }), description: "A read-only preview of the dashboard you unlock inside AI Campus — streaks, paths, and live signals." }),
